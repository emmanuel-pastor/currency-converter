...
class DBService {
  ...
  static Future<void> _createExchangeRateTable(Database db) async {
    return db.execute(
      'CREATE TABLE ${StringConstants.tableName}(${StringConstants.id} INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ${StringConstants.from_currency_code} TEXT, ${StringConstants.from_currency_name} TEXT, ${StringConstants.to_currency_code} TEXT, ${StringConstants.to_currency_name} TEXT, ${StringConstants.exchange_rate} FLOAT)',
    );
  }
}
